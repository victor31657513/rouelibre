...
Produire un diagnostic déterministe des distributions d'espacement horizontal, de variation d'altitude et de valeur absolue de pente brute, par étape et sur le corpus agrégé, avec percentiles et effectifs au-dessus de seuils diagnostiques explicites, sans modifier aucune donnée.
