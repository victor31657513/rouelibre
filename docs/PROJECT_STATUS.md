...
- Corpus dérivé et testé de 20 segments situés dans les queues diagnostiques extrêmes : variation absolue strictement supérieure à 50 m ou pente brute absolue strictement supérieure à 1. Chaque cas relie les indices normalisés aux indices GPX bruts et conserve ses métriques non arrondies et son voisinage, sans qualifier l’altitude réelle ni choisir une correction.
...
Choisir, dans une tâche dédiée, une stratégie minimale de préparation altimétrique à comparer sur le corpus traçable, les profils synthétiques et les invariants de la décision 0007, sans implémenter simultanément la conversion vers `PrecompiledCourse`.
