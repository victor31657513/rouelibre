...
- Banc d'essai altimétrique neutre, déterministe et limité aux tests : la référence non candidate `identity` applique les 34 métriques aux 14 profils synthétiques, aux 21 traces complètes et aux 43 cas, réussit les 20 invariants et conserve exactement les données. Le rapport exhaustif est comparé uniquement en mémoire ; seul son résumé compact et son empreinte SHA-256 sont versionnés.
