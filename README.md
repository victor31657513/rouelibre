...
Le laboratoire permet de régler la puissance demandée de 0 à 1 200 W, le vent longitudinal de -10 à +10 m/s, la pente longitudinale constante de -20 % à +20 % dans le mode `Pente constante`, et de sélectionner un parcours segmenté fixe (0 %, +5 %, -5 %, 0 % aux frontières 0, 200, 400 et 600 m), de démarrer ou mettre en pause l'exécution, de réinitialiser le scénario et d'avancer exactement une seconde simulée lorsque l'exécution est en pause.
...
Le dépôt ne contient pas de GPX, altitude issue d'un parcours, virages, longueur totale finie, ligne d’arrivée, position latérale, aspiration, plusieurs coureurs, intelligence artificielle, tactique, psychologie, Three.js, scène 3D, Zustand, Web Worker, moteur de corps rigides, collisions, adhérence, sons, sauvegarde, backend applicatif ou authentification.
