...
`)+`
`+f);const M=b+p+a,E=b+f+o,L=Ac(r,r.VERTEX_SHADER,M),w=Ac(r,r.FRAGMENT_SHADER,E);r.attachShader(_,L),r.attachShader(_,w),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function A(R){if(n.debug.checkShaderErrors){const H=r.getProgramInfoLog(_).trim(),N=r.getShaderInfoLog(L).trim(),G=r.getShaderInfoLog(w).trim();let W=!0,z=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(W=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,L,w);else{const $=Cc(r,L,"vertex"),V=Cc(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
