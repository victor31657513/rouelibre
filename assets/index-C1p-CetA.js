...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function yc(){return new On({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:el(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function Mc(){return new On({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:el(),fragmentShader:`
...
#define LOW_PRECISION`),e}function U_(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===bu?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Zd?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===un&&(e="SHADOWMAP_TYPE_VSM"),e}function N_(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Bi:case zi:e="ENVMAP_TYPE_CUBE";break;case ia:e="ENVMAP_TYPE_CUBE_UV";break}return e}function O_(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case zi:e="ENVMAP_MODE_REFRACTION";break}return e}function F_(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case wu:e="ENVMAP_BLENDING_MULTIPLY";break;case Eh:e="ENVMAP_BLENDING_MIX";break;case bh:e="ENVMAP_BLENDING_ADD";break}return e}function k_(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function B_(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=U_(t),c=N_(t),u=O_(t),d=F_(t),h=k_(t),m=T_(t),g=A_(s),_=r.createProgram();let p,f,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(cr).join(`
`)),a=Ro(a),a=Lc(a,t),a=Pc(a,t),o=Ro(o),o=Lc(o,t),o=Pc(o,t),a=Ic(a),o=Ic(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
</div>`)),gx=Tl(`<div class="calendar-weeks">
